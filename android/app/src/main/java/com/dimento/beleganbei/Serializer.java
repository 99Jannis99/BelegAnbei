...
public class Serializer {
    ...
    /* Read the value of "exit_on_sent" in the intent's extra. Defaults to false. */
    ...
    /* Extract the list of items from clip data (if available). Defaults to null. */
    ...
    /* Extract the list of items from the intent's extra stream. See Intent.EXTRA_STREAM for details. */
    ...
    /* Extract the list of items from the intent's getData. See Intent.ACTION_VIEW for details. */
